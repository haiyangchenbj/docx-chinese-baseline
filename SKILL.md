...
version: "1.0.0"
description: "Locked design-token baseline for Chinese Word/DOCX documents and WeChat-native article layouts. Trigger keywords: 中文 docx 排版, html to docx 样式丢失, Word 中文文档美化, 16 18 23 px 基线, 深蓝标题, WeChat article typesetting, 公众号排版基线, Windows html-to-docx 失败. Fixed sizes 16/18/23px with deep-blue headings, plus a stable conversion path on Windows."
description_zh: "中文 Word 文档与公众号原生排版的锁定设计基线：正文 16px / 小标题 18px / 标题 23px、深蓝 #1a3a5c 标题色、禁 HTML 表格卡片背景、Windows html-to-docx 稳定转换路径。基线变更必须先改本 skill。"
read_when: "Typesetting a Chinese DOCX or WeChat-native article, or when html-to-docx conversion fails on Windows."
not_for:
